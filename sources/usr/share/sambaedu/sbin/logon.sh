#!/bin/bash
# Run and Kill share's services defined in /usr/share/sambaedu/shares/%NAME%
# Works like Sys V init

## $Id$ ##


RC_SHARE=/usr/share/sambaedu/shares/shares.d
VERBOSE=0
LOGON=0
LOGOUT=0
...
echo "user: " $2 "->" $user "machine : " $machine >>/var/log/samba/debug.log
