...
$config_purif = HTMLPurifier_Config::createDefault();
$config_purif->set('Core.Encoding', 'utf-8'); // replace with your encoding
$config_purif->set('HTML.Doctype', 'XHTML 1.0 Strict'); // replace with your doctype
$purifier = new HTMLPurifier($config_purif);
