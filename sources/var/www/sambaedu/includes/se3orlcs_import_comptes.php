<?php
	...
	*/
	...
	// Detection LCS ou SE4
	if ( file_exists("/var/www/sambaedu") ) {$servertype="sambaedu";}
	else {$servertype="LCS";}
	...
	// ===========================================================
		...
		if($servertype=="LCS") {
			...
			unset($tabssmtp);
			#require ("/var/www/sambaedu/import_sconet/crob_ldap_functions.php");
			require ("/var/www/sambaedu/includes/crob_ldap_functions.php");
			$tabssmtp=lireSSMTP();
	...
	if($servertype=="LCS") {
		...
		include "/var/www/sambaedu/includes/config.inc.php";
	    include "/var/www/sambaedu/includes/ldap.inc.php";
		include "/var/www/sambaedu/includes/ihm.inc.php";
		require ("/var/www/sambaedu/includes/crob_ldap_functions.php");

		require_once ("/var/www/sambaedu/includes/lang.inc.php");
		bindtextdomain('sambaedu-annu',"/var/www/sambaedu/locale");
		textdomain ('sambaedu-annu');
	}
	...
	if($servertype=="LCS") {
		...
		// Il faudra appliquer un correct SID lors de l'installation d'un sambaedu
