...
// Verifie les droits
if ((have_right($config, "computers_is_admin")) or (have_right($config, "parc_can_view")) or (have_right($config, "parc_can_manage")) or
(have_right($config, "inventaire_can_read"))) {
