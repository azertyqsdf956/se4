...
if ($is_admin = have_right($config, "se3_is_admin")) {
...
$pmarque=(isset($_POST['pmarque'])?$_POST['pmarque']:(isset($_GET['pmarque'])?$_GET['pmarque']:""));
$pversion=(isset($_POST['pversion'])?$_POST['pversion']:(isset($_GET['pversion'])?$_GET['pversion']:""));
$pdriver=(isset($_POST['pdriver'])?$_POST['pdriver']:(isset($_GET['pdriver'])?$_GET['pdriver']:""));
$pcable=(isset($_POST['pcable'])?$_POST['pcable']:(isset($_GET['pcable'])?$_GET['pcable']:""));
$pport=(isset($_POST['pport'])?$_POST['pport']:(isset($_GET['pport'])?$_GET['pport']:""));
$ptype=(isset($_POST['ptype'])?$_POST['ptype']:(isset($_GET['ptype'])?$_GET['ptype']:""));
...
//########################### IP Master #########################################//
$post_slave=(isset($_POST['slave'])?$_POST['slave']:"");
if ($post_slave=="yes") {
	if ($_POST['ipslave']!="") {
    		$ok=1;$i=1;
    		// split ipslave
...
9cessite les droits d'administrateur du serveur SambaEdu !")."</div>";
