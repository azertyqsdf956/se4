...
$wrep = (isset ($_POST['wrep'])?$_POST['wrep']:(isset ($_GET['wrep'])?$_GET['wrep']:""));
//if($wrep=="") { $wrep=$_GET['wrep']; }
if ($wrep!="") {
	// test si l'entree est correcte
	if((is_dir($wrep)) || (is_file($wrep))) {
		echo "<H1>".gettext("Occupation de $wrep")."</H1>";
		$reponse=system("/usr/bin/sudo /usr/share/sambaedu/scripts/du.sh $wrep");
		echo "$reponse";
		require("pdp.inc.php");
		exit;
	} else { $erreur="1"; }
...
<FORM ACTION="du.php" METHOD="post">
  <TABLE ALIGN="center" WIDTH="50%" BORDER="1">
  	<TR>
  		...
  		<TD><IMG SRC="/elements/images/folder.png" BORDER="0" ALT="R&#233;pertoire">&nbsp;&nbsp;<A HREF="Javascript:setpath('/var/sambaedu/Progs');">/var/sambaedu/Progs</A></TD>
  	</TR>
  	<TR>
  		<TD><?php echo gettext("Dossier Documents"); ?></TD>
  		<TD><IMG SRC="/elements/images/folder.png" BORDER="0" ALT="R&#233;pertoire">&nbsp;&nbsp;<A HREF="Javascript:setpath('/var/sambaedu/Docs');">/var/sambaedu/Docs</A></TD>
  	</TR>
	<TR>
  		<TD><?php echo gettext("Dossier public"); ?></TD>
  		<TD><IMG SRC="/elements/images/folder.png" BORDER="0" ALT="R&#233;pertoire">&nbsp;&nbsp;<A HREF="Javascript:setpath('/var/sambaedu/Docs/public');">/var/sambaedu/Docs/public</A></TD>
  	</TR>
  	<TR>
  		<TD><?php echo gettext("Dossier Classes"); ?></TD>
  		<TD><IMG SRC="/elements/images/folder.png" BORDER="0" ALT="R&#233;pertoire">&nbsp;&nbsp;<A HREF="Javascript:setpath('/var/sambaedu/Classes');">/var/sambaedu/Classes</A></TD>
  	</TR>
